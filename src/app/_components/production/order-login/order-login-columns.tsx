...
import { ProcessedOrderLoginLead } from "@/types/production/order-login.types";

interface GetOrderLoginTableColumnsProps {
  setRowAction: React.Dispatch<
    React.SetStateAction<
      DataTableRowActionFinalMeasurement<ProcessedOrderLoginLead> | null
    >
  >;
  userType?: string;
}

export function getOrderLoginTableColumns({
  setRowAction,
  userType,
}: GetOrderLoginTableColumnsProps): ColumnDef<ProcessedOrderLoginLead>[] {
  return [
    // Lead Code
    {
      ...
      ? [
          {
            ...
            enableColumnFilter: true,
            enableHiding: true,
          } as ColumnDef<ProcessedOrderLoginLead>,
        ]
      : []),
