...
import DispatchPlanningTable from "@/components/installation/dispatch-planning/DispatchPlanningTable";
    ...
    <SidebarProvider>
      ...
      <SidebarInset className="w-full h-full overflow-x-hidden flex flex-col">
        ...
        <main className="flex-1 p-4 pt-0 overflow-x-hidden">
          <Suspense fallback={<p>Loading Dispatch Planning Leads...</p>}>
