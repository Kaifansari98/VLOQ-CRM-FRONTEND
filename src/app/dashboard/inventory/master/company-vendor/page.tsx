...
export default function InventoryCompanyVendorMasterPage() {
  return (
    <>
        ...
        <div className="flex items-center gap-2">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator className="hidden md:block" />
              <BreadcrumbItem>
                <BreadcrumbPage>Company Vendor Master</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
        ...
        <Suspense
          fallback={
            <div className="flex h-[400px] items-center justify-center text-sm text-muted-foreground animate-pulse">
              Loading Company Vendor Masters...
            </div>
          }
        >
          <CompanyVendorMastersTable />
        </Suspense>
      </div>
    </>
  );
