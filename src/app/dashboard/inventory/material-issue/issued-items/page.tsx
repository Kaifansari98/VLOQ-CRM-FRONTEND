...
const navigateOrderLogin = (row: any) =>
  ...
  }&source=material-issue&mode=issued`;

export default function MaterialIssueIssuedItemsPage() {
  return (
    <>
        ...
        <div className="flex items-center gap-2">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage>Material Issue - Issued Projects</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
      ...
      <main className="flex-1 overflow-x-hidden">
        <Suspense fallback={<DataTableSkeleton columnCount={10} rowCount={8} />}>
          <UniversalTable
            title="Issued Projects"
            description="Projects whose required production materials have been fully issued."
            type="Type 9"
