        ...
        <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
          ...
          <div className="grid auto-rows-min gap-4 md:grid-cols-3">
           ...
           <GenerateLeadFormModal>
              <Card className="aspect-video flex items-center justify-center cursor-pointer hover:bg-muted/50 transition">
                <p className="text-muted-foreground">Click here to Generate Leads</p>
              </Card>
            </GenerateLeadFormModal>
          ...
          <Card className="min-h-[60vh] flex items-center justify-center">
            <div className="text-center">
              <h3 className="text-2xl font-semibold mb-2">Lead Management Dashboard</h3>
              <p className="text-muted-foreground">Your lead generation tools will go here</p>
            </div>
          </Card>
        </div>
      </SidebarInset>
