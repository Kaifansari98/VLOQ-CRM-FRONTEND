...
import { ExternalLink, Calendar, User, FileText, IndianRupee, Clock } from "lucide-react";
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        ...
        >
          ...
          />
          <p className="text-muted-foreground font-medium">Loading payment logs...</p>
        </motion.div>
      </div>
    );
  }
  ...
  if (!logs.length) {
    return (
      ...
      >
        ...
        <p className="text-muted-foreground font-medium text-lg">No payment records available.</p>
      </motion.div>
    );
  }
                    ...
                    {log.payment_text && (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-sm font-medium leading-relaxed">{log.payment_text}</p>
                        </div>
                      </motion.div>
                    )}
                  </div>
