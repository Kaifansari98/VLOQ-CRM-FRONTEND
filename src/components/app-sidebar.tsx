  ...
  trackTraceNav: [
    ...
    },
    {
      ...
      items: [
        {
          title: "Workstation",
          url: "/dashboard/track-trace/master/workstation",
        },
  ...
  inventoryTraceNav: [
    {
      ...
      icon: Warehouse,
      items: [
        { title: "Products", url: "/dashboard/inventory/master/products/list" },
        {
          title: "Purchase Enquiry",
          url: "/dashboard/inventory/purchase-intents",
        },
        {
        ...
        { title: "GRN", url: "/dashboard/inventory/grn" },
        {
          ...
          url: "/dashboard/inventory/payment-requisitions",
        },
...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  const { navItems, trackTraceItems, inventoryItems, mastersItems } =
    React.useMemo(() => {
      ...
      const finalInventoryItems =
        isSuperAdmin && isInventoryEnabled ? data.inventoryTraceNav : [];
      const finalMastersItems =
        isSuperAdmin && isCrmEnabled
