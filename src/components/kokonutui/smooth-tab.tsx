  ...
  return (
    <div className="flex flex-col h-full gap-3">
      ...
      >
        ...
        <div className="flex w-full gap-1 relative z-[2] dark:px-1">
          {items.map((item) => {
            ...
            const isDisabled = isOrderLoginTab && !canOrderLogin(userType);
            ...
            if (isDisabled) {
              return (
                <CustomeTooltip
                  ...
                  value="🚫 You don’t have permission to access the Order Login section."
                />
              );
            }
      ...
      <div className="flex-1 mb-4 relative h-full">
        <div className="bg-card rounded-lg h-[100vh] w-full relative">
