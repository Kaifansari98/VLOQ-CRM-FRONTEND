...
import { ProcessedOrderLoginLead as ProcessedReadyToDispatchLead } from "@/types/production/order-login.types";

interface GetReadyToDispatchTableColumnsProps {
  setRowAction: React.Dispatch<
    React.SetStateAction<
      DataTableRowActionFinalMeasurement<ProcessedReadyToDispatchLead> | null
    >
  >;
  userType?: string;
}

export function getReadyToDispatchTableColumns({
  setRowAction,
  userType,
}: GetReadyToDispatchTableColumnsProps): ColumnDef<ProcessedReadyToDispatchLead>[] {
  return [
    {
