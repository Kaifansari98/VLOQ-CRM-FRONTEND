...
const ReadyToDispatchTable = () => {
  ...
  // 🔹 Fetch Data
  const { data, isLoading, isError } = useReadyToDispatchLeads(
    vendorId!,
    userId!,
  ...
  if (isLoading) return <p>Loading Ready-To-Dispatch leads...</p>;
  if (isError) return <p>Error loading Ready-To-Dispatch leads</p>;
