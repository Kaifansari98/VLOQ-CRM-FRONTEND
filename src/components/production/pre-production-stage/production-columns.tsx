...
import { ProcessedOrderLoginLead as ProcessedProductionLead } from "@/types/production/order-login.types";

interface GetProductionTableColumnsProps {
  setRowAction: React.Dispatch<
    React.SetStateAction<
      DataTableRowActionFinalMeasurement<ProcessedProductionLead> | null
    >
  >;
  userType?: string;
}

export function getProductionTableColumns({
  setRowAction,
  userType,
}: GetProductionTableColumnsProps): ColumnDef<ProcessedProductionLead>[] {
  return [
    // Lead Code
    {
    ...
    // Client Name
    {
      ...
      meta: { label: "Client Name", variant: "text", icon: Text },
      enableSorting: true,
      enableColumnFilter: true,
      enableHiding: true,
      cell: ({ row }) => {
    ...
    // Assigned User (only for admins/managers)
      ...
      ? [
          {
            ...
            enableColumnFilter: true,
            enableHiding: true,
          } as ColumnDef<ProcessedProductionLead>,
        ]
      : []),
