...
import { ProcessedOrderLoginLead as ProcessedSiteReadinessLead } from "@/types/production/order-login.types";

interface GetSiteReadinessTableColumnsProps {
  setRowAction: React.Dispatch<
    React.SetStateAction<
      DataTableRowActionFinalMeasurement<ProcessedSiteReadinessLead> | null
    >
  >;
  userType?: string;
}
...
/**
 * ✅ Table Columns for Site Readiness Stage
 */
export function getSiteReadinessTableColumns({
  setRowAction,
  userType,
}: GetSiteReadinessTableColumnsProps): ColumnDef<ProcessedSiteReadinessLead>[] {
  return [
    {
