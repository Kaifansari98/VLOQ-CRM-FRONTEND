...
type SpecTabId = "carcass" | "shutter" | "sub-shutter" | "handles";
type SpecSourceRow =
  | CarcassTypeMasterEntry
  | ShutterTypeMasterEntry
  | HandleTypeMasterEntry
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new {activeLabel.toLowerCase()} spec master entry for
              this vendor.
            </DialogDescription>
          </DialogHeader>

          <div className="space-y-2">
            <Label htmlFor="spec-master-name">{activeLabel} Name</Label>
            <Input
              id="spec-master-name"
              value={newValue}
