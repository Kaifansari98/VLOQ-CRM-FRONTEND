...
import { useRescheduleFinalMeasurementTask } from "@/hooks/final-measurement/use-final-measurement";
...
const FinalMeasurementTaskModal: React.FC<Props> = ({
  open,
  onOpenChange,
  onComplete,
  data,
  ...
  const rescheduleMutation = useRescheduleFinalMeasurementTask();
  ...
  const handleReschedule = () => {
    ...
    rescheduleMutation.mutate(
      ...
      },
      {
        onSuccess: () => {
          toastManager.add({
            title: "Final Measurement task rescheduled successfully!",
            type: "success",
          });
  ...
  return (
    <>
      <BaseModal
        ...
        title="Final Measurement Task"
        description="Complete this task by opening the Final Measurement form, or reschedule it to a new date."
        size="md"
      >
        <div className="space-y-4 p-6">
          <div className="flex items-center justify-between rounded-xl border p-3 gap-3">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm text-muted-foreground">
                Open the Final Measurement form and complete this task.
              </p>
            </div>
            <Button
              className="w-28"
          ...
          <div className="flex items-center justify-between rounded-xl border p-3 gap-3">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm text-muted-foreground">
                If the visit date has changed, reschedule this task.
              </p>
            </div>
            <Button
              className="w-28"
      ...
      <BaseModal
        ...
        title="Reschedule Final Measurement"
        description="Set a new due date and add a remark for this Final Measurement task."
        size="md"
      >
...
export default FinalMeasurementTaskModal;
